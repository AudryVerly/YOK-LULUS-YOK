                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-5 z-index-2">
                        <div
                            ...
                            <h6 class="text-white text-capitalize m-0">Formulir</h6>
                        </div>
                    </div>
                    ...
                    <div class="card-body px-2 pb-2">
                        <div class="table-responsive p-0">
                            <table id="tabelLowonganfor" class="table align-items-center mb-0">
                                <thead clss="bg-light">
                                    <tr>
                                        ...
                                        <tr class={{ $low->status == 0 ? 'table-secondary' : '' }}>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('formulir.manage', $low->id) }}"
