...
class LowonganSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('lowongan')->insert([
            ...
            [
                'idUnit' => 3,
                'judulLowongan' => 'Asisten Seketariat Mahasiswa',
                'deskripsi' => 'Membantu segala urusan keperluan mahasiswa.',
                'kualifikasi' => 'Minat Pelayanan Umum',
                'posisiLowongan' => 'Student Employee Seketariat',
                'durasiKerja' => 3,
